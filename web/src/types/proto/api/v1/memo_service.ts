...
export interface GetShareMemoRequest {
  /** Required. Memo UID. */
  id: string;
...
export interface GetShareMemoResponse {
  memo?: Memo | undefined;
  creator?: User | undefined;
}

export interface CreateMemoShareImageRequest {
  /**
...
function createBaseGetShareMemoRequest(): GetShareMemoRequest {
  return { id: "", token: "" };
}

export const GetShareMemoRequest: MessageFns<GetShareMemoRequest> = {
  encode(message: GetShareMemoRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetShareMemoRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetShareMemoRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  create(base?: DeepPartial<GetShareMemoRequest>): GetShareMemoRequest {
    return GetShareMemoRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetShareMemoRequest>): GetShareMemoRequest {
    const message = createBaseGetShareMemoRequest();
...
function createBaseGetShareMemoResponse(): GetShareMemoResponse {
  return { memo: undefined, creator: undefined };
}

export const GetShareMemoResponse: MessageFns<GetShareMemoResponse> = {
  encode(message: GetShareMemoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.memo !== undefined) {
      Memo.encode(message.memo, writer.uint32(10).fork()).join();
    }
    if (message.creator !== undefined) {
      User.encode(message.creator, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetShareMemoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetShareMemoResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  create(base?: DeepPartial<GetShareMemoResponse>): GetShareMemoResponse {
    return GetShareMemoResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetShareMemoResponse>): GetShareMemoResponse {
    const message = createBaseGetShareMemoResponse();
...
function createBaseCreateMemoShareImageRequest(): CreateMemoShareImageRequest {
  return { name: "", theme: "", locale: "", width: 0, height: 0, mode: "", deviceScaleFactor: 0 };
}

export const CreateMemoShareImageRequest: MessageFns<CreateMemoShareImageRequest> = {
  encode(message: CreateMemoShareImageRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.theme !== "") {
    ...
    if (message.deviceScaleFactor !== 0) {
      writer.uint32(61).float(message.deviceScaleFactor);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateMemoShareImageRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCreateMemoShareImageRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 7: {
          ...
          message.deviceScaleFactor = reader.float();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  create(base?: DeepPartial<CreateMemoShareImageRequest>): CreateMemoShareImageRequest {
    return CreateMemoShareImageRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CreateMemoShareImageRequest>): CreateMemoShareImageRequest {
    const message = createBaseCreateMemoShareImageRequest();
    message.name = object.name ?? "";
    ...
    message.deviceScaleFactor = object.deviceScaleFactor ?? 0;
    return message;
  },
};
...
export const MemoServiceDefinition = {
  ...
  methods: {
    ...
    /** GetShareMemo gets memo data for share rendering. */
    getShareMemo: {
      name: "GetShareMemo",
      requestType: GetShareMemoRequest,
      requestStream: false,
      responseType: GetShareMemoResponse,
      responseStream: false,
      options: {
        _unknownFields: {
    ...
    /** CreateMemoShareImage renders a share image for a memo. */
    createMemoShareImage: {
      name: "CreateMemoShareImage",
      requestType: CreateMemoShareImageRequest,
      requestStream: false,
