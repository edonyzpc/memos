...
type GetAttachmentBinaryRequest struct {
	...
	// Optional. Signed URL expiration timestamp (unix seconds).
	Exp int64 `protobuf:"varint,4,opt,name=exp,proto3" json:"exp,omitempty"`
	// Optional. Signed URL signature (hex HMAC).
...
func (x *GetAttachmentBinaryRequest) GetExp() int64 {
	if x != nil {
		return x.Exp
	}
	return 0
...
func (x *GetAttachmentBinaryRequest) GetSig() string {
	if x != nil {
		return x.Sig
	}
	return ""
...
const file_api_v1_attachment_service_proto_rawDesc = "" +
	...
	"\x17memos.api.v1/AttachmentR\x04name\"\xc3\x01\n" +
	...
	"\tthumbnail\x18\x03 \x01(\bB\x03\xe0A\x01R\tthumbnail\x12\x15\n" +
	"\x03exp\x18\x04 \x01(\x03B\x03\xe0A\x01R\x03exp\x12\x15\n" +
	"\x03sig\x18\x05 \x01(\tB\x03\xe0A\x01R\x03sig\"\x9a\x01\n" +
