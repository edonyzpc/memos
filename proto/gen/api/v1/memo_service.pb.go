...
func (MemoRelation_Type) EnumDescriptor() ([]byte, []int) {
	return file_api_v1_memo_service_proto_rawDescGZIP(), []int{15, 0}
}
...
type GetShareMemoRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Required. Memo UID.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// Required. Share JWT token.
	Token         string `protobuf:"bytes,2,opt,name=token,proto3" json:"token,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetShareMemoRequest) Reset() {
	*x = GetShareMemoRequest{}
	mi := &file_api_v1_memo_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetShareMemoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetShareMemoRequest) ProtoMessage() {}

func (x *GetShareMemoRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_memo_service_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetShareMemoRequest.ProtoReflect.Descriptor instead.
func (*GetShareMemoRequest) Descriptor() ([]byte, []int) {
	return file_api_v1_memo_service_proto_rawDescGZIP(), []int{2}
}

func (x *GetShareMemoRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *GetShareMemoRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
type GetShareMemoResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetShareMemoResponse) Reset() {
	*x = GetShareMemoResponse{}
	mi := &file_api_v1_memo_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetShareMemoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetShareMemoResponse) ProtoMessage() {}

func (x *GetShareMemoResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_memo_service_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetShareMemoResponse.ProtoReflect.Descriptor instead.
func (*GetShareMemoResponse) Descriptor() ([]byte, []int) {
	return file_api_v1_memo_service_proto_rawDescGZIP(), []int{3}
}

func (x *GetShareMemoResponse) GetMemo() *Memo {
	if x != nil {
		return x.Memo
	}
	return nil
...
func (x *GetShareMemoResponse) GetCreator() *User {
	if x != nil {
		return x.Creator
	}
	return nil
...
type CreateMemoShareImageRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Required. The memo name.
	// Format: memos/{memo}
	Name string `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// Optional. Theme for rendering ("light" or "dark").
	Theme string `protobuf:"bytes,2,opt,name=theme,proto3" json:"theme,omitempty"`
	// Optional. Locale for rendering.
	Locale string `protobuf:"bytes,3,opt,name=locale,proto3" json:"locale,omitempty"`
	// Optional. Target width (px).
	Width int32 `protobuf:"varint,4,opt,name=width,proto3" json:"width,omitempty"`
	// Optional. Target height (px).
	Height int32 `protobuf:"varint,5,opt,name=height,proto3" json:"height,omitempty"`
	// Optional. Render mode ("auto" or "fixed").
	Mode string `protobuf:"bytes,6,opt,name=mode,proto3" json:"mode,omitempty"`
	// Optional. Device scale factor for rendering.
	DeviceScaleFactor float32 `protobuf:"fixed32,7,opt,name=device_scale_factor,json=deviceScaleFactor,proto3" json:"device_scale_factor,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *CreateMemoShareImageRequest) Reset() {
	*x = CreateMemoShareImageRequest{}
	mi := &file_api_v1_memo_service_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateMemoShareImageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateMemoShareImageRequest) ProtoMessage() {}

func (x *CreateMemoShareImageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_memo_service_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateMemoShareImageRequest.ProtoReflect.Descriptor instead.
func (*CreateMemoShareImageRequest) Descriptor() ([]byte, []int) {
	return file_api_v1_memo_service_proto_rawDescGZIP(), []int{4}
}

func (x *CreateMemoShareImageRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *CreateMemoShareImageRequest) GetTheme() string {
	if x != nil {
		return x.Theme
	}
	return ""
...
func (x *CreateMemoShareImageRequest) GetLocale() string {
	if x != nil {
		return x.Locale
	}
	return ""
...
func (x *CreateMemoShareImageRequest) GetWidth() int32 {
	if x != nil {
		return x.Width
	}
	return 0
...
func (x *CreateMemoShareImageRequest) GetHeight() int32 {
	if x != nil {
		return x.Height
	}
	return 0
...
func (x *CreateMemoShareImageRequest) GetMode() string {
	if x != nil {
		return x.Mode
	}
	return ""
...
func (x *CreateMemoShareImageRequest) GetDeviceScaleFactor() float32 {
	if x != nil {
...
const file_api_v1_memo_service_proto_rawDesc = "" +
	...
	"\a_parentB\v\n" +
	"\t_location\"E\n" +
	"\x13GetShareMemoRequest\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x02R\x02id\x12\x19\n" +
	"\x05token\x18\x02 \x01(\tB\x03\xe0A\x02R\x05token\"l\n" +
	"\x14GetShareMemoResponse\x12&\n" +
	"\x04memo\x18\x01 \x01(\v2\x12.memos.api.v1.MemoR\x04memo\x12,\n" +
	"\acreator\x18\x02 \x01(\v2\x12.memos.api.v1.UserR\acreator\"\x8a\x02\n" +
	"\x1bCreateMemoShareImageRequest\x12-\n" +
	"\x04name\x18\x01 \x01(\tB\x19\xe0A\x02\xfaA\x13\n" +
	"\x11memos.api.v1/MemoR\x04name\x12\x19\n" +
	"\x05theme\x18\x02 \x01(\tB\x03\xe0A\x01R\x05theme\x12\x1b\n" +
	"\x06locale\x18\x03 \x01(\tB\x03\xe0A\x01R\x06locale\x12\x19\n" +
	"\x05width\x18\x04 \x01(\x05B\x03\xe0A\x01R\x05width\x12\x1b\n" +
	"\x06height\x18\x05 \x01(\x05B\x03\xe0A\x01R\x06height\x12\x17\n" +
	"\x04mode\x18\x06 \x01(\tB\x03\xe0A\x01R\x04mode\x123\n" +
	"\x13device_scale_factor\x18\a \x01(\x02B\x03\xe0A\x01R\x11deviceScaleFactor\"u\n" +
	"\bLocation\x12%\n" +
	...
	"\aGetMemo\x12\x1c.memos.api.v1.GetMemoRequest\x1a\x12.memos.api.v1.Memo\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18\x12\x16/api/v1/{name=memos/*}\x12|\n" +
	"\fGetShareMemo\x12!.memos.api.v1.GetShareMemoRequest\x1a\".memos.api.v1.GetShareMemoResponse\"%\xdaA\x02id\x82\xd3\xe4\x93\x02\x1a\x12\x18/api/v1/share/memos/{id}\x12\x7f\n" +
	"\n" +
	...
	"\n" +
	"DeleteMemo\x12\x1f.memos.api.v1.DeleteMemoRequest\x1a\x16.google.protobuf.Empty\"%\xdaA\x04name\x82\xd3\xe4\x93\x02\x18*\x16/api/v1/{name=memos/*}\x12\x8d\x01\n" +
	"\x14CreateMemoShareImage\x12).memos.api.v1.CreateMemoShareImageRequest\x1a\x14.google.api.HttpBody\"4\xdaA\x04name\x82\xd3\xe4\x93\x02':\x01*\"\"/api/v1/{name=memos/*}/share-image\x12\x8b\x01\n" +
...
var file_api_v1_memo_service_proto_goTypes = []any{
	...
	(*GetShareMemoRequest)(nil),         // 4: memos.api.v1.GetShareMemoRequest
	(*GetShareMemoResponse)(nil),        // 5: memos.api.v1.GetShareMemoResponse
	(*CreateMemoShareImageRequest)(nil), // 6: memos.api.v1.CreateMemoShareImageRequest
	(*Location)(nil),                    // 7: memos.api.v1.Location
	(*CreateMemoRequest)(nil),           // 8: memos.api.v1.CreateMemoRequest
...
var file_api_v1_memo_service_proto_depIdxs = []int32{
	...
	17, // 7: memos.api.v1.Memo.relations:type_name -> memos.api.v1.MemoRelation
	...
	7,  // 10: memos.api.v1.Memo.location:type_name -> memos.api.v1.Location
	3,  // 11: memos.api.v1.GetShareMemoResponse.memo:type_name -> memos.api.v1.Memo
	33, // 12: memos.api.v1.GetShareMemoResponse.creator:type_name -> memos.api.v1.User
	3,  // 13: memos.api.v1.CreateMemoRequest.memo:type_name -> memos.api.v1.Memo
	31, // 14: memos.api.v1.ListMemosRequest.state:type_name -> memos.api.v1.State
	...
	34, // 17: memos.api.v1.UpdateMemoRequest.update_mask:type_name -> google.protobuf.FieldMask
	...
	29, // 20: memos.api.v1.MemoRelation.memo:type_name -> memos.api.v1.MemoRelation.Memo
	29, // 21: memos.api.v1.MemoRelation.related_memo:type_name -> memos.api.v1.MemoRelation.Memo
	...
	8,  // 29: memos.api.v1.MemoService.CreateMemo:input_type -> memos.api.v1.CreateMemoRequest
	9,  // 30: memos.api.v1.MemoService.ListMemos:input_type -> memos.api.v1.ListMemosRequest
	11, // 31: memos.api.v1.MemoService.GetMemo:input_type -> memos.api.v1.GetMemoRequest
	4,  // 32: memos.api.v1.MemoService.GetShareMemo:input_type -> memos.api.v1.GetShareMemoRequest
	12, // 33: memos.api.v1.MemoService.UpdateMemo:input_type -> memos.api.v1.UpdateMemoRequest
	13, // 34: memos.api.v1.MemoService.DeleteMemo:input_type -> memos.api.v1.DeleteMemoRequest
	6,  // 35: memos.api.v1.MemoService.CreateMemoShareImage:input_type -> memos.api.v1.CreateMemoShareImageRequest
	14, // 36: memos.api.v1.MemoService.SetMemoAttachments:input_type -> memos.api.v1.SetMemoAttachmentsRequest
	15, // 37: memos.api.v1.MemoService.ListMemoAttachments:input_type -> memos.api.v1.ListMemoAttachmentsRequest
	18, // 38: memos.api.v1.MemoService.SetMemoRelations:input_type -> memos.api.v1.SetMemoRelationsRequest
	19, // 39: memos.api.v1.MemoService.ListMemoRelations:input_type -> memos.api.v1.ListMemoRelationsRequest
	21, // 40: memos.api.v1.MemoService.CreateMemoComment:input_type -> memos.api.v1.CreateMemoCommentRequest
	22, // 41: memos.api.v1.MemoService.ListMemoComments:input_type -> memos.api.v1.ListMemoCommentsRequest
	24, // 42: memos.api.v1.MemoService.ListMemoReactions:input_type -> memos.api.v1.ListMemoReactionsRequest
	26, // 43: memos.api.v1.MemoService.UpsertMemoReaction:input_type -> memos.api.v1.UpsertMemoReactionRequest
	27, // 44: memos.api.v1.MemoService.DeleteMemoReaction:input_type -> memos.api.v1.DeleteMemoReactionRequest
	3,  // 45: memos.api.v1.MemoService.CreateMemo:output_type -> memos.api.v1.Memo
	10, // 46: memos.api.v1.MemoService.ListMemos:output_type -> memos.api.v1.ListMemosResponse
	3,  // 47: memos.api.v1.MemoService.GetMemo:output_type -> memos.api.v1.Memo
	5,  // 48: memos.api.v1.MemoService.GetShareMemo:output_type -> memos.api.v1.GetShareMemoResponse
	...
	36, // 51: memos.api.v1.MemoService.CreateMemoShareImage:output_type -> google.api.HttpBody
	35, // 52: memos.api.v1.MemoService.SetMemoAttachments:output_type -> google.protobuf.Empty
	16, // 53: memos.api.v1.MemoService.ListMemoAttachments:output_type -> memos.api.v1.ListMemoAttachmentsResponse
	35, // 54: memos.api.v1.MemoService.SetMemoRelations:output_type -> google.protobuf.Empty
	20, // 55: memos.api.v1.MemoService.ListMemoRelations:output_type -> memos.api.v1.ListMemoRelationsResponse
	3,  // 56: memos.api.v1.MemoService.CreateMemoComment:output_type -> memos.api.v1.Memo
	23, // 57: memos.api.v1.MemoService.ListMemoComments:output_type -> memos.api.v1.ListMemoCommentsResponse
	25, // 58: memos.api.v1.MemoService.ListMemoReactions:output_type -> memos.api.v1.ListMemoReactionsResponse
	2,  // 59: memos.api.v1.MemoService.UpsertMemoReaction:output_type -> memos.api.v1.Reaction
	35, // 60: memos.api.v1.MemoService.DeleteMemoReaction:output_type -> google.protobuf.Empty
