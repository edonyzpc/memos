...
const (
	...
	MemoService_GetShareMemo_FullMethodName         = "/memos.api.v1.MemoService/GetShareMemo"
	...
	MemoService_CreateMemoShareImage_FullMethodName = "/memos.api.v1.MemoService/CreateMemoShareImage"
...
type MemoServiceClient interface {
	...
	GetShareMemo(ctx context.Context, in *GetShareMemoRequest, opts ...grpc.CallOption) (*GetShareMemoResponse, error)
	...
	CreateMemoShareImage(ctx context.Context, in *CreateMemoShareImageRequest, opts ...grpc.CallOption) (*httpbody.HttpBody, error)
...
func (c *memoServiceClient) GetShareMemo(ctx context.Context, in *GetShareMemoRequest, opts ...grpc.CallOption) (*GetShareMemoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetShareMemoResponse)
	err := c.cc.Invoke(ctx, MemoService_GetShareMemo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *memoServiceClient) CreateMemoShareImage(ctx context.Context, in *CreateMemoShareImageRequest, opts ...grpc.CallOption) (*httpbody.HttpBody, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(httpbody.HttpBody)
	err := c.cc.Invoke(ctx, MemoService_CreateMemoShareImage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MemoServiceServer interface {
	...
	// GetShareMemo gets memo data for share rendering.
	GetShareMemo(context.Context, *GetShareMemoRequest) (*GetShareMemoResponse, error)
	// UpdateMemo updates a memo.
	UpdateMemo(context.Context, *UpdateMemoRequest) (*Memo, error)
	// DeleteMemo deletes a memo.
	DeleteMemo(context.Context, *DeleteMemoRequest) (*emptypb.Empty, error)
	// CreateMemoShareImage renders a share image for a memo.
	CreateMemoShareImage(context.Context, *CreateMemoShareImageRequest) (*httpbody.HttpBody, error)
	// SetMemoAttachments sets attachments for a memo.
...
func (UnimplementedMemoServiceServer) GetShareMemo(context.Context, *GetShareMemoRequest) (*GetShareMemoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetShareMemo not implemented")
}
...
func (UnimplementedMemoServiceServer) CreateMemoShareImage(context.Context, *CreateMemoShareImageRequest) (*httpbody.HttpBody, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateMemoShareImage not implemented")
}
...
func _MemoService_GetShareMemo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetShareMemoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemoServiceServer).GetShareMemo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemoService_GetShareMemo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemoServiceServer).GetShareMemo(ctx, req.(*GetShareMemoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _MemoService_CreateMemoShareImage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateMemoShareImageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MemoServiceServer).CreateMemoShareImage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MemoService_CreateMemoShareImage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MemoServiceServer).CreateMemoShareImage(ctx, req.(*CreateMemoShareImageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MemoService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetShareMemo",
			Handler:    _MemoService_GetShareMemo_Handler,
		},
		{
		...
		{
			MethodName: "CreateMemoShareImage",
			Handler:    _MemoService_CreateMemoShareImage_Handler,
		},
		{
